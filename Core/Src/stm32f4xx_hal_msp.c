...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC0     ------> ADC1_IN10
    */
    HAL_GPIO_DeInit(HV_FUSE_TEMPERATURE_GPIO_Port, HV_FUSE_TEMPERATURE_Pin);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PC1     ------> ADC2_IN11
    */
    HAL_GPIO_DeInit(PRECHARGE_TEMPEREATURE_GPIO_Port, PRECHARGE_TEMPEREATURE_Pin);
  ...
  else if(hadc->Instance==ADC3)
  {
    ...
    PC3     ------> ADC3_IN13
    */
    HAL_GPIO_DeInit(AUX_TEMPERATURE1_GPIO_Port, AUX_TEMPERATURE1_Pin);
